...
**/
(function() {
	// Use Douglas Crockford's JSON class because we can't be sure that a JS library (I'm looking at you
	// Mootools) won't replace the native JSON object
    ...
    if (window === top) {
        ...
        if (libs.length > 0) {
            document.getElementById('d41d8cd98f00b204e9800998ecf8427e_lib_detect').content = JSON.stringify(libs);
        }
    }
})();
